...
#  {background-image="figs/journey.png" background-opacity="0.6" background-size="95%"}
...
- *Note*: refer to the newest case (not always), there will be two different interview, first with the faculty member, second with the graduate admission commitee 
